...
def parse():
    ...
    parser.add_argument('-lF', '--feature_lambda', type=float, default=1.0, help='feature l2 coefficient')
    ...
    parser.add_argument('-l1', '--l1_lambda', type=float, default=0.0, help='l1 coefficient')
