...
def parse():
    ...
    parser.add_argument('-l', '--learning_rate', type=float, default=1e-1, help='learning rate of the encoder training')
    parser.add_argument('-nE', '--exp_name', type=str, default='exp', help='experiment name')
    parser.add_argument('-dD', '--data_dir', type=str, default='C:/Users/BHKIM/Documents/abd_ct', help='directory path to load dataset')
    ...
    parser.add_argument('--image_idx', type=int, default=0, help='index of the image in the directory list')
