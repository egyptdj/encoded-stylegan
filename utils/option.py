...
def parse():
    ...
    parser.add_argument('-lS', '--searchlight_lambda', type=float, default=1.0, help='searchlight coefficient')
    parser.add_argument('-lE', '--encoding_lambda', type=float, default=0.0, help='encoding coefficient')
    parser.add_argument('-lES', '--encoding_sigmoid_lambda', type=float, default=0.0, help='encoding sigmoid coefficient')
