...
def parse():
    ...
    parser.add_argument('-n', '--randomize_noise', type=bool, default=True, help='randomize noise')
    parser.add_argument('-lE', '--encoding_lambda', type=float, default=1.0, help='encoding coefficient')
    parser.add_argument('-lE', '--lpips_lambda', type=float, default=1.0, help='lpips coefficient')
