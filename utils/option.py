...
def parse():
    ...
    parser.add_argument('-lLP', '--lpips_lambda', type=float, default=1.0, help='lpips coefficient')
    parser.add_argument('-lLAP', '--laploss_lambda', type=float, default=1.0, help='laploss coefficient')
    ...
    parser.add_argument('-ms', '--modeseek', type=float, default=1.0, help='use modeseek regularizer coefficient')
