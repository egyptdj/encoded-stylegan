...
def parse():
    ...
    parser.add_argument('-lES', '--encoding_sigmoid_lambda', type=float, default=0.0, help='encoding coefficient')
    ...
    parser.add_argument('-fs', '--fused_scale', type=bool, default=True, help='fused scale')
