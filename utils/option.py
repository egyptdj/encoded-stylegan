...
def parse():
    ...
    parser.add_argument('-n', '--randomize_noise', type=bool, default=False, help='randomize noise for encoder training')
    parser.add_argument('-lE', '--encoding_lambda', type=float, default=1e7, help='coefficient of the encoding loss')
    parser.add_argument('-lL', '--l2_lambda', type=float, default=1e5, help='coefficient of the l2 loss')
    ...
    parser.add_argument('--last_res', type=int, default=2, help='last layer resolution of the encoder')
