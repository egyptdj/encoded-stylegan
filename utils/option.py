...
def parse():
    ...
    parser.add_argument('-r', '--disc_resolution', type=int, default=64, help='discriminator resolution')
    ...
    parser.add_argument('-dG', '--generated_dataset', type=bool, default=False, help='generated dataset or FFHQ')
