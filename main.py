...
def main():
    ...
    with tf.name_scope('loss'):
        ...
        with tf.name_scope('gan_loss'):
            ...
            latent_discriminator = tflib.Network("Dlat", func_name='stylegan.training.networks_stylegan.G_mapping', dlatent_size=1, mapping_layers=base_option['mapping_layers'], latent_size=18*512, normalize_latents=False)
    ...
    for iter in tqdm(range(base_option['num_iter'])):
        ...
        iter_scalar_summary, val_iter_scalar_summary, _ = sess.run([scalar_summary, test_scalar_summary, g_optimize], feed_dict={test_image_input: val_imbatch}) # UPDATE GENERATORS
